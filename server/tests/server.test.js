  ...
  it('should update the todo', (done) => {
   ...
   it('should clear completedAt when todo is not completed', (done) => {
      ...
      request(app) 
        .patch(`/todos/${hexId}`)
        .set('x-auth', users[1].tokens[0].token)
        .send({"text": "This is new text", "completed": false})
        .expect(200) 
        .expect((res) => {
          expect(res.body.todo.text).toBe("This is new text"); 
...
describe('POST /users', () => {
  ...
  it('should return validation errors if request invalid', (done) => {
    var invalidEmail = "nickexample.com"; 
    var invalidPassword = 'five'; 
